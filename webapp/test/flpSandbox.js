		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vendor App",
									"targetURL": "#comappvendorapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappvendorapplication-display": {
								"semanticObject": "comappvendorapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.vendorapplication",
									"url": sap.ui.require.toUrl("com/app/vendorapplication")
								}
							}
						}
					}
